 ...
 */
export const messageToUniversalURI = message =>  `https://id.uport.me/req/${trimURI(message)}`
 ...
 */
export const messageToDeeplinkURI = message => `me.uport:req/${trimURI(message)}`
 ...
 */
export const messageToURI = (message, type = 'universal') =>
